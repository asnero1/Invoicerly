        ...
        <>
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-500">ü"ç {task.client}</p>
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-gray-600">
            <p>
              ü"Ö <strong>Logged:</strong> {task.date}
            </p>
            <p>
              ‚è∞ <strong>Due:</strong> {task.dueDate || 'N/A'}
            </p>
            <p>
              ü'∞ <strong>Amount:</strong> ${task.amount?.toFixed(2) || '0.00'}
            </p>
            <p>
              ‚úÖ <strong>Billable:</strong> {task.billable ? 'Yes' : 'No'}
            </p>
          </div>

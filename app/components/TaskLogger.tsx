...
const TaskLogger: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('voiceNote', task.voiceNote || '') // Default to an empty string if no voice note
      formData.append('dueDate', task.dueDate || '') // Fix undefined to empty string
      formData.append('priority', task.priority || 'Medium') // Set default priority if undefined
      formData.append('tags', JSON.stringify(task.tags || [])) // Fix for undefined tags

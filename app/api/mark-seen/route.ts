  ...
  try {
    ...
    messages.forEach((msg: any) => {
      const isContactMatch =
        [msg.sender.toLowerCase(), msg.receiver.toLowerCase()].includes(viewer.toLowerCase()) &&
        [msg.sender.toLowerCase(), msg.receiver.toLowerCase()].includes(contact.toLowerCase());

      if (isContactMatch && msg.sender.toLowerCase() === contact.toLowerCase()) {
